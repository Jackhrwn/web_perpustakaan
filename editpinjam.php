...
include 'koneksi.php';
    $id = $_GET['id'];
    $query_pinjam = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE id_peminjaman = '$id'");
    $data = mysqli_fetch_assoc($query_pinjam);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="content">
        ...
        <form action="proses_editpinjam.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select id="id_buku" name="id_buku" required>
                    ...
                    while($data_buk = mysqli_fetch_assoc($buk)) {
                        $pilih = ($data_buk['id_buku'] == $data['id_buku']) ? 'selected' : '';
                        echo "<option value='{$data_buk['id_buku']}' $pilih>{$data_buk['judul_buku']}</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_peminjam" name="nama_peminjam" value="<?= $data['nama_peminjam']; ?>" required>
            </div>
